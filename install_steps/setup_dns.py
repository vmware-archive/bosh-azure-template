...
def do_step(context):
    ...
    if enable_dns:
        try:
            ...
            call("python setup_dns.py -d {0} -i 10.0.16.11 -e {1} >/dev/null 2>&1".format(fqdn, cf_ip), shell=True)
            # Update motd
            ...
            err_msg += "\nYou can setup DNS manually with \"python setup_dns.py -d CF_Domain_Wildcard -i 10.0.16.11 -e External_IP_of_CloudFoundry\""
